...
Google Calendar; a filesystem check for local files/browser history);
...
# Gmail and GitHub have no extractor built yet — always reported as
# "not_configured" with a distinct detail message, never silently
# folded into "ok" or "error". Google Calendar is checked live below.
_NOT_YET_BUILT = {
